...
def create_variables_full_iMAT(
    model, rH, rL, fraction_of_optimum, epsilon, o2_constraint=None
):
    """
...
def run_iMAT(args):
    ...
    prob, v_vars, y_vars = create_variables_full_iMAT(
        args.model,
        rewardedReactions,
        penalizedReactions,
        args.optimum,
        args.epsilon,
        args.oxygenConstraint,
    )
