...
def create_expression_variable_full(model, rH, rM, rL, gene_expression,fraction_of_optimum, epsilon, threshold_low, threshold_high, ignore_human = False, o2_constraint=None):
    '''
...
def run_tripleWeighted_iMAT(args):
    ...
    prob, v_vars, y_vars, c_vars = create_expression_variable_full(args.model, rewardedReactions,moderateReactions, penalizedReactions, RNASeqData, args.optimum ,args.epsilon,
    ...
    #Output files
        ...
        output_utils.create_outputFiles(prob,args.output, RNASeqData, args.discretization, args.expressionColName, penalizedReactions, rewardedReactions,
                                        moderateReactions, upper_threshold, lower_threshold, args.epsilon, v_vars, y_vars, c_vars,triple=True, o2Constraint=args.oxygenConstraint)
