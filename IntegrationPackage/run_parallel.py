...
def run_parallel():
        ...
        for epsilon, lower_q, upper_q in itertools.product(SensAnalysis.epsilon_range, SensAnalysis.lower_q_range, SensAnalysis.upper_q_range)
        if lower_q < upper_q
        ]
        ...
        for file in input_files:
            ...
            for c, exprColName in enumerate(SensAnalysis.exprColNames):
                rnaSeq_df = utils.generate_RNASeqDf(model, expression_df, SensAnalysis.geneColName)
