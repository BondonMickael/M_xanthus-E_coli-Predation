...
def build_parser():
    ...
    # weighted iMAT
    weighted_imat_parser = subparser.add_parser('weighted_iMAT', help='Run weighted iMAT')
...
def add_iMAT_shared_args(p):
    ...
    p.add_argument('-x', '--oxygenLevel', type = float, default = None,
